...
class AccumulatorContextFactory:
    ...
    def build_predictor(self, time_series_repository):
        forwarders = build_forwarder(self._configurations, self._logger)
        predictor_logger = LoggingUtils("predictor", self._configurations)
    ...
    def build_manager(self, time_series_repository, predictor):
        ...
        entities_handlers = build_entity_handler(time_series_repository, entity_ids_by_label, self._configurations, self._logger)
        manager_logger = LoggingUtils("manager", self._configurations)
    ...
    def build_accumulator(self, manager):
        accumulator_logger = LoggingUtils("accumulator", self._configurations)
