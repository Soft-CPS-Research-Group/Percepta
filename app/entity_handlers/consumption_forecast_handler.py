...
class ConsumptionForecastHandler(EntityHandlerBase):
                ...
                if data:
                    ...
                    for param in FORECAST_SERVICES_PARAMETERS:
                        ...
                        if isinstance(values_list, list):
                            values_list.sort(key=lambda x: x.get("timestamp", 0))  # isto deve estar a dar sort por string e nao timestamp, tenho de analisar
    ...
    def fallback(self, device_id, substitute_dict):
        ...
        for param_name, param_info in parameters.items():
            if param_info.get('label') == ParamLabel.CONSUMPTION_TOTAL.value:
        ...
        data_list = device_substitute.get('data', {}).get(ParamLabel.CONSUMPTION_TOTAL.value, [])
        ...
        if data_list:
            ...
            if now < expiry_time:
                ...
                device_substitute['data'][ParamLabel.CONSUMPTION_TOTAL.value] = remaining_data
